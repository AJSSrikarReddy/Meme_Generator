...
function showJoke(){
    const jkdata=getRandom('jokes');
    const jokeDiv=document.querySelector('.joke-content');
    const newJoke=document.createElement('p');
    newJoke.textContent=jkdata;
    clearAll();
    jokeDiv.appendChild(newJoke);
}
function showQuote(){
    const quoteData=getRandom('quotes');
    const qoteDiv=document.querySelector('.quote-content');
    const newQoure=document.createElement('p');
    const newQoureAuthor=document.createElement('p');
    newQoure.textContent=quoteData.quote;
    newQoureAuthor.textContent='-'+quoteData.author;
    clearAll();
    qoteDiv.appendChild(newQoure);
    qoteDiv.appendChild(newQoureAuthor);
}
